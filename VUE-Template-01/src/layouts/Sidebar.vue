        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand"
                        ...
                        <h2 class="brand-text"><span
                                style="font-weight: bolder; font-family: Roboto; font-size: 20px;">VV</span> Vuexy</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a class="d-flex align-items-center" href="page-account-settings.html"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Account Settings">Account
                                    Settings</span></a>
                        </li>
                        ...
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span
                            ...
                            <ul class="menu-content">
                                ...
                                <li><a class="d-flex align-items-center"
                                        ...
                                        target="_blank"><span class="menu-item text-truncate"
                                            data-i18n="Deactivate Account">Deactivate
                                            Account</span></a>
                                </li>
                                <li><a class="d-flex align-items-center"
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="form-validation.html"><i
                            ...
                            data-i18n="Form Validation">Form
                            Validation</span></a>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="maps-leaflet.html"><i
                            ...
                            data-i18n="Leaflet Maps">Leaflet
                            Maps</span></a>
                </li>
